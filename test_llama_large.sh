...
#SBATCH --output=/scratch/%u/llama_large_%j.out
#SBATCH --error=/scratch/%u/llama_large_%j.err
...
for EXP in $EXPERIMENTS; do
    echo ""
    echo "============================================"
    echo "=== Testing exp_$EXP (large) ==="
    echo "============================================"
    python run_llama_tests.py --exp $EXP --size large 2>&1 || echo "FAILED: exp_$EXP"
done

echo ""
echo "=== All large experiments completed ==="
