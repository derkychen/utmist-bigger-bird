...
class BiggerBirdAttention(BigBirdBlockSparseAttention):
    ...
    def bigbird_block_sparse_attention(
        ...
        # Also reconstruct the context vector by accumulating weighted value contributions from
