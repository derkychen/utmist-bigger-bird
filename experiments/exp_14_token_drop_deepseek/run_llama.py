"""Exp 14 Token Drop Deepseek — exp_14_token_drop_deepseek_llama on R1-Distill-Llama-8B.

Run on a GPU node:
    source /scratch/$USER/r1-venv/bin/activate
    python exp_14_token_drop_deepseek/run_llama.py
"""
...
from experiments.exp_14_token_drop_deepseek.model_llama import build_model
...
def main():
    ...
    run_llama_experiment(
        "exp_14_token_drop_deepseek_llama",
        model,
        tokenizer,
        ds,
        train_cfg,
        extra_meta={"drop_after_layer": 3, "drop_ratio": 0.3, "top_k": 64, "low_rank_dim": 16, "base_model": "r1-distill-llama-8b"},
    )
