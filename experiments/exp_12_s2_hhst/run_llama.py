"""Exp 12 S2 Hhst — exp_12_s2_hhst_llama on R1-Distill-Llama-8B.

Run on a GPU node:
    source /scratch/$USER/r1-venv/bin/activate
    python exp_12_s2_hhst/run_llama.py
"""
...
from experiments.exp_12_s2_hhst.model_llama import build_model
...
def main():
    ...
    run_llama_experiment(
        "exp_12_s2_hhst_llama",
        model,
        tokenizer,
        ds,
        train_cfg,
        extra_meta={"base_model": "r1-distill-llama-8b"},
    )
