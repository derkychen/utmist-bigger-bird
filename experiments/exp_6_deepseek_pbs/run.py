...
from experiments.exp_6_deepseek_pbs.model import PatchedModel
...
def main():
    ...
    params = dict(top_k=64, low_rank_dim=16, block_size=32, num_blocks=4)
    ...
    run_experiment("exp_6_deepseek_pbs", model, tokenizer, ds, train_cfg, extra_meta=params)
