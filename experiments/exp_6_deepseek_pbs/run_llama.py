"""Exp 6 Deepseek Pbs — exp_6_deepseek_pbs_llama on R1-Distill-Llama-8B.

Run on a GPU node:
    source /scratch/$USER/r1-venv/bin/activate
    python exp_6_deepseek_pbs/run_llama.py
"""
...
from experiments.exp_6_deepseek_pbs.model_llama import build_model
...
def main():
    ...
    run_llama_experiment(
        "exp_6_deepseek_pbs_llama",
        model,
        tokenizer,
        ds,
        train_cfg,
        extra_meta={"top_k": 64, "low_rank_dim": 16, "block_size": 32, "num_blocks": 4, "base_model": "r1-distill-llama-8b"},
    )
