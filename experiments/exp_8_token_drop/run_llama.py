"""Exp 8 Token Drop — exp_8_token_drop_llama on R1-Distill-Llama-8B.

Run on a GPU node:
    source /scratch/$USER/r1-venv/bin/activate
    python exp_8_token_drop/run_llama.py
"""
...
from experiments.exp_8_token_drop.model_llama import build_model
...
def main():
    ...
    run_llama_experiment(
        "exp_8_token_drop_llama",
        model,
        tokenizer,
        ds,
        train_cfg,
        extra_meta={"drop_after_layer": 3, "drop_ratio": 0.3, "base_model": "r1-distill-llama-8b"},
    )
