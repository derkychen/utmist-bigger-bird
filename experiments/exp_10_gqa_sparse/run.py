...
from experiments.exp_10_gqa_sparse.model import PatchedModel
...
def main():
    ...
    params = dict(kv_groups=4, top_k=64, low_rank_dim=16)
    ...
    run_experiment("exp_10_gqa_sparse", model, tokenizer, ds, train_cfg, extra_meta=params)
