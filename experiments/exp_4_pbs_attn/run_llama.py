"""Exp 4 Pbs Attn — exp_4_pbs_attn_llama on R1-Distill-Llama-8B.

Run on a GPU node:
    source /scratch/$USER/r1-venv/bin/activate
    python exp_4_pbs_attn/run_llama.py
"""
...
from experiments.exp_4_pbs_attn.model_llama import build_model
...
def main():
    ...
    run_llama_experiment(
        "exp_4_pbs_attn_llama",
        model,
        tokenizer,
        ds,
        train_cfg,
        extra_meta={"block_size": 64, "num_blocks": 2, "base_model": "r1-distill-llama-8b"},
    )
