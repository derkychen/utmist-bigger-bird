"""Exp 3 Dynamic Globals — exp_3_dynamic_globals_llama on R1-Distill-Llama-8B.

Run on a GPU node:
    source /scratch/$USER/r1-venv/bin/activate
    python exp_3_dynamic_globals/run_llama.py
"""
...
from experiments.exp_3_dynamic_globals.model_llama import build_model
...
def main():
    ...
    run_llama_experiment(
        "exp_3_dynamic_globals_llama",
        model,
        tokenizer,
        ds,
        train_cfg,
        extra_meta={"window_size": 64, "num_globals": 16, "base_model": "r1-distill-llama-8b"},
    )
