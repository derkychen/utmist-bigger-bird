"""Exp 15 Bigger Bird — exp_15_bigger_bird_llama on R1-Distill-Llama-8B.

Run on a GPU node:
    source /scratch/$USER/r1-venv/bin/activate
    python exp_15_bigger_bird/run_llama.py
"""
...
from experiments.exp_15_bigger_bird.model_llama import build_model
...
def main():
    ...
    run_llama_experiment(
        "exp_15_bigger_bird_llama",
        model,
        tokenizer,
        ds,
        train_cfg,
        extra_meta={"fragment_size": 128, "max_k": 64, "base_model": "r1-distill-llama-8b"},
    )
