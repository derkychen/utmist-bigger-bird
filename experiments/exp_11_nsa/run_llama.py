"""Exp 11 Nsa — exp_11_nsa_llama on R1-Distill-Llama-8B.

Run on a GPU node:
    source /scratch/$USER/r1-venv/bin/activate
    python exp_11_nsa/run_llama.py
"""
...
from experiments.exp_11_nsa.model_llama import build_model
...
def main():
    ...
    run_llama_experiment(
        ...
        ds,
        train_cfg,
        extra_meta={"block_size": 32, "window_size": 128, "base_model": "r1-distill-llama-8b"},
    )
