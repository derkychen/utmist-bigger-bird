...
#SBATCH --output=/scratch/%u/mask_fix_%j.out
#SBATCH --error=/scratch/%u/mask_fix_%j.err
...
# Test the 4 previously-failing experiments with small dataset
for EXP in 1 8 13 14; do
    echo ""
    echo "============================================"
    echo "=== Testing exp_$EXP (small) with mask fix ==="
    echo "============================================"
    python run_llama_tests.py --exp $EXP --size small 2>&1 || echo "FAILED: exp_$EXP"
done
echo ""
echo "=== All mask-fix tests completed ==="
