...
#SBATCH --output=/scratch/%u/sweep_ruler_128k_dynctx_%j.out
#SBATCH --exclude=fc11013

# Exp 13 and 15 at 128K (will time out in other jobs)
set -euo pipefail
...
echo "========================================"
echo "Exp 13 and 15 at 128K"
echo "$(date -Iseconds)"
echo "========================================"

# Exp 13 at 128K with k=512
...
echo "=== 128K DYNCTX SWEEP COMPLETE: $(date -Iseconds) ==="
