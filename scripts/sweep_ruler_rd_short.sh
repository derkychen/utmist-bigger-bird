...
#SBATCH --output=/scratch/%u/sweep_ruler_rd_short_%j.out

# Short R&D sweep: just 4K and 8K for the new experiments
# This gives us quick signal on whether the parameter-free methods work at all.
...
echo "========================================"
echo "RULER R&D SHORT sweep (4K, 8K only)"
echo "$(date -Iseconds)"
echo "========================================"

# Exp 16 (Free NSA) at 4K and 8K
run_ruler 16 4096 '{"block_size": 64, "topk_blocks": 16, "window_size": 256, "use_triton": false}'
run_ruler 16 8192 '{"block_size": 64, "topk_blocks": 16, "window_size": 256, "use_triton": false}'

# Exp 17 (Coarse-to-fine) at 4K and 8K
run_ruler 17 4096 '{"block_size": 128, "topk_blocks": 32, "fine_k": 512, "window_size": 256, "use_triton": false}'
run_ruler 17 8192 '{"block_size": 128, "topk_blocks": 32, "fine_k": 512, "window_size": 256, "use_triton": false}'

# Exp 15 (BiggerBird proper) at 4K and 8K
...
run_ruler 15 8192 '{"fragment_size": 128, "max_k": 1024, "min_k": 128, "globals_per_head": 32, "teleports_per_head": 8, "use_teleports": false, "use_triton": false}'

# Exp 4 with larger budget
run_ruler 4 4096 '{"block_size": 128, "num_blocks": 8, "use_triton": false}'
run_ruler 4 8192 '{"block_size": 128, "num_blocks": 8, "use_triton": false}'

# Exp 10 with larger budget
run_ruler 10 4096 '{"top_k": 512, "low_rank_dim": 128, "use_triton": false}'
run_ruler 10 8192 '{"top_k": 512, "low_rank_dim": 128, "use_triton": false}'

echo "=== SHORT SWEEP COMPLETE: $(date -Iseconds) ==="
