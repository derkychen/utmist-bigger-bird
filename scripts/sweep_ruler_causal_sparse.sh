...
#SBATCH --output=/scratch/%u/sweep_ruler_causal_%j.out

# RULER niah sweep with REAL causal sparse attention (no dense fallback)
# Usage: sbatch --export=EXPS="0 1 2",SEQS="4096 8192" scripts/sweep_ruler_causal_sparse.sh
# Defaults: all 16 experiments, 4K-128K
...
# Default: all 16 experiments
EXPS="${EXPS:-0 13 1 8 14 15 7 10 2 3 4 5 6 9 11 12}"
...
echo "========================================"
echo "RULER niah CAUSAL SPARSE sweep"
echo "Exps: $EXPS"
echo "Seqs: $SEQS"
echo "Real causal sparse attention (no dense fallback)"
echo "========================================"
...
echo "=== CAUSAL SPARSE SWEEP COMPLETE: $(date -Iseconds) ==="
