...
#SBATCH --output=/scratch/%u/sweep_lra_text_fixed_%j.out

# LRA Text for experiments that failed due to is_causal bug
set -euo pipefail
...
echo "========================================"
echo "LRA Text FIXED sweep (exps 2-12 with is_causal fix)"
echo "========================================"
...
echo "=== LRA TEXT FIXED SWEEP COMPLETE: $(date -Iseconds) ==="
